...
export const HomeBannerData= 
  ...
  export const homepackagedata ={
    ...
    section1:{img:thailand3,
      ...
      btntext: "Explore Packages",
      href: "/packages/thailand-tour?categorys=international",
    },
    section2:{img:srilanka6,
      title: "Sri Lanka",
      para: "Discover rich culture, ancient temples, vibrant markets,",
      btntext: "Explore Packages",
      href: "/packages/enchanting-sri-lanka-tour?categorys=international",
    },
    section3:{img:bali4,
      title: "Bali",
      para: "Discover rich culture, ancient temples, vibrant markets,",
      btntext: "Explore Packages",
      href: "/packages/bali-discovery-trip?categorys=international",
    },
    section4:{img:singapore8,
      title: "Singapore",
      para: "Discover rich culture, ancient temples, vibrant markets,",
      btntext: "Explore Packages",
      href: "/packages/singapore-tour?categorys=international",
    }
  }
